...
function CardSprite:createCard( cbCardData, tagParam )
	...
	sp.m_strCardFile = tagParam._file or "res/gamepai/pai@2x.png"
    --print("tex:"..tex..";sp:"..sp..";File:"..sp.m_strCardFile)
...
function CardSprite:showSelectEffect(bSelect)
	...
	if nil == self.m_pMask then
		self.m_pMask = cc.Sprite:create("res/gamepai/pai@2x.png")
		if nil ~= self.m_pMask then
...
function CardSprite:createBack( )
	...
	--纹理区域
	local rect = cc.rect(0, 4 * c_height, c_width, c_height);
